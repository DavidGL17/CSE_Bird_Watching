...
opencv_createsamples -info info/info.lst -num 900 -w 20 -h 20 -vec positives.vec
opencv_traincascade -data data -vec positives.vec -bg bg.txt -numPos 800 -numNeg 400 -numStages 10 -w 20 -h 20